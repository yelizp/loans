...
1. customer-loans
2. kafka-record-gen
   Produces synthetic Account and Loan records to Kafka. You may use run.bat file to runProducer.bat the module.
...
2. Start zookeeper
    %KAFKA_HOME%\bin\windows\kafka-server-start.bat D:\kafka_2.12-2.7.0\config\server.properties
3. Start kafka
    %KAFKA_HOME%\bin\windows\kafka-server-start.bat D:\kafka_2.12-2.7.0\config\server.properties
4. Start producer
